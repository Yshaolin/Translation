...
*由RNA多聚酶介导的RNA多聚反应*。在这种方式中，模板的复制是由RNA多聚酶催化的结果。对于很多人来说，这种RNA多聚酶代表着RNA世界的圣杯，因为如果它能作用于跟他一样长度的模板上，那么它就能够通过交替复制自己和互补链来维持自我催化的循环。R18就是这种类型的一个例子，它是衍生于第一类连接酶。这种途径也能从低温环境中受益。Holliger团队

This is new line
We wil add new contents here.
Here we go.
