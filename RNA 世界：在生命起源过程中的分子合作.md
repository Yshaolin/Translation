...
另一个关键点是酶催化的聚合反应速率应该比无酶催化时对模板序列更加不敏感。多聚酶也能够复制不同的序列，这些序列具有其他功能但不是聚合本身。这样，我就设想建立具有很多核酶的系统，这个系统能够控制新陈代谢的功能，所有的酶都是由同样的聚合酶来复制的。这将能够和现代生物体的遗传系统相当，现代的遗传系统具有单一的DNA复制、RNA转录和蛋白质翻译机制以不同的功能操作着基因。
